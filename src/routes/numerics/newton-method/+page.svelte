...
<article>
  <section>
    <h2 class="title">$\S$ Newton's Method</h2>
  </section>

  <section>
    <p>
      $y = f(x)$ 의 도함수를 알고 있는 경우 기울기를 이용하여 $f(x) = 0$ 의 해를 찾아가는 방법입니다.
    ...
    <p>
      ...
      초기 값 $x_0 = 3.5$ 로 부터 시작해서 $(2)$ 를 반복하여 해를 찾아가 보겠습니다.
      $(2)$ 의 $x_0$ 에 초기 값 $3.5$ 를 대입하면 $Fig.1$ 과 같이 $x \approx 2.0357$ 를 얻을 수 있습니다.
    </p>
